...
class SummarizationService:
        ...
        try:
            ...
            try:
                self.tokenizer = AutoTokenizer.from_pretrained(
                    self.model_name, legacy=False, use_fast=False
                )
            except TypeError:
    ...
    def generate_summary(
        self, text: str, max_length: int = 150, min_length: int = 80
    ) -> str:
        """
        ...
        try:
            ...
            inputs = self.tokenizer.encode(
                input_text, return_tensors="pt", max_length=1028, truncation=True
            )
