...
# Removed: from ..config import get_settings
# Removed: settings = get_settings()
...
router.include_router(named_entity_recognition_router, tags=["Named entity recognition"])
