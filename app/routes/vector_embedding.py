...
from ..models.vector_embedding import (
    TextInput,
    TextsInput,
    EmbeddingResponse,
...
async def embed_text(text_input: TextInput, _=Depends(validate_api_key)):
...
async def embed_texts_batch(texts_input: TextsInput, _=Depends(validate_api_key)):
