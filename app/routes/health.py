...
async def health_check():
    return {
        ...
        "endpoints": [
            ...
            {"path": f"{settings.api_v1_str}/sentiment", "method": "POST", "description": "Sentiment analysis"},
            {"path": f"{settings.api_v1_str}/emotions", "method": "POST", "description": "Emotion analysis"}
        ]
    }
